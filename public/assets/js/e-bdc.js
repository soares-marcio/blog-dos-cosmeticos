$(function(){
	var youtube_api_key = 'API_KEY';//process.env.YOUTUBE_API_KEY;
  ...
  // browser
	...
	var toggleMobile = function() {
		...
		$(document).on("click", ".nav-list li.bdc-dropdown > a", function() {
			var $this = $(this),
					$parent = $this.parent(),
